...
p=0;
% start of computational domain in x direction
q=100;
% end of computational domain in x direction
r=0;
% start of computational domain in y direction
s=100;
% end of computational domain in y direction
vx=0.5;
...
u0=zeros(NX,NY);
% vector of initial u values filled with zeros
%
...
exact=zeros(NX,NY);
% define correct sized exact solution array
%
